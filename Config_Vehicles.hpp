class CarShops {
    ...
    */
    ...
    class med_shop {
        side = "med";
        vehicles[] = {
			{ "C_Van_01_box_F", 13000, { "life_medlevel", "SCALAR", -1 } },
            { "C_Offroad_01_F", 13000, { "life_medlevel", "SCALAR", 2 } },
			{ "C_SUV_01_F", 13000, { "life_medlevel", "SCALAR", 3 } },
			{ "C_Hatchback_01_sport_F", { "life_medlevel", "SCALAR", 4 } },
			{ "B_MRAP_01_F", { "life_medlevel", "SCALAR", 5 } }
        };
    };
    ...
    class med_air_hs {
        side = "med";
        vehicles[] = {
            { "B_Heli_Light_01_F", { "life_medlevel", "SCALAR", 2 } },
			{ "O_Heli_Light_02_unarmed_F", { "life_medlevel", "SCALAR", 4 } },
			{ "O_Heli_Transport_04_black_F", { "life_medlevel", "SCALAR", 5 } }
        };
    };
    ...
    class cop_car {
        ...
        vehicles[] = {
			...
			{ "B_MRAP_01_hmg_F", { "life_coplevel", "SCALAR", 10 } }
        };
    };
    ...
    class cop_air {
        ...
        vehicles[] = {
            ...
            { "B_Heli_Transport_01_F", { "life_coplevel", "SCALAR", 9 } },
			{ "B_Heli_Transport_03_F", { "life_coplevel", "SCALAR", 9 } }
        };
    };
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "Polizei", "cop", {
                "textures\cop\Cop_Hatchback.jpg"
            } }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
			...
			{ "ZOLL", "cop", {
                "textures\cop\zollBird.paa"
            } },
			{ "SEK", "cop", {
                "textures\cop\sekBird.paa"
            } },
        };
    };
	...
	class I_MRAP_03_F { 
        ...
        textures[] = {
			{ "SEK", "cop", {
                "textures\cop\strider_sek.paa"
            } },
			{ "Polizei", "cop", {
                "textures\cop\Cop_Strider.jpg"
            } }
	...
	class I_Heli_light_03_unarmed_F {
        ...
        textures[] = {
			{ "Polizei", "cop", {
                "textures\cop\polizei_hellcat.jpg"
            } }
        };
    };
